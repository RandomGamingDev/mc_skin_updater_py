...
def convert(oldSkin): # The function assumes that you already checked that this is an old MC skin
	...
	legUL = ImageOps.mirror(oldSkin.crop((4, 16, 4 + 4, 16 + 4)))
	newSkin.paste(legUL, (20, 48))
	legUR = oldSkin.crop((8, 16, 8 + 4, 16 + 4))
	...
	legUL = ImageOps.mirror(oldSkin.crop((44, 16, 44 + 4, 16 + 4)))
	newSkin.paste(legUL, (36, 48))
	legUR = ImageOps.mirror(oldSkin.crop((48, 16, 48 + 4, 16 + 4)))
